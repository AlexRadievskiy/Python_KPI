...
# г) за грудень 2016 – лютий 2018; д) д) за 2016 та 2017 на одному графіку (паралельно).

# 2.Знайти максимальні значення найбільшої ціни за день
# а) за 2016 рік;
# б) за кожний рік;
# в) за кожний тиждень весни 2019 року.
# г) Розрахувати і зобразити зміни значення найбільшої ціни за день у відсотках за кожен день впродовж весни 2018 року.
# д) Знайти та зобразити графічно ковзне середнє найбільшої ціни за день за 2017 рік з вікном в два місяці.
